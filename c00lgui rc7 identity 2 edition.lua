...
rede = Color3.new(0/255,0/255,255/255)
tef = "SourceSans"
whit = Color3.new(255/255,255/255,255/255)
local cka = Instance.new("ScreenGui", PLRGUI)
cka.Name= "CoolGui"
...
local title = Instance.new("TextLabel")
	...
	title.Text = "c00lgui Reborn Rc7 by v4rx"
...
local textbx = Instance.new("TextBox")
		...
		textbx.Text = "50"
		textbx.TextColor3 = whit
		cka.Frame.Size = UDim2.new(0,3,0,4)
	local titl = Instance.new("TextLabel")
		titl.Parent = wsa
		titl.BackgroundColor3 = blak
		titl.BorderColor3 = rede
...
for i,v in pairs(main:GetChildren())do
	if v.Visible == true and v.Name ~= 'EmptyPage' and v.ClassName == 'Frame' then
		local openpageid = tonumber(v.Name:sub(5))
		if openpageid ~= 1 then
			v.Visible = false
			main['Page'..tostring(openpageid-1)].Visible = true
			break
		else
			v.Visible = false
			main['Page'..tostring(#main:GetChildren())].Visible = true
			break
		end
	end
end
...
for i,v in pairs(main:GetChildren())do
	if v.Visible == true and v.Name ~= 'EmptyPage' and v.ClassName == 'Frame' then
		local openpageid = tonumber(v.Name:sub(5))
		if openpageid ~= #main:GetChildren() then
			v.Visible = false
			main['Page'..tostring(openpageid+1)].Visible = true
			break
		else
			v.Visible = false
			main['Page'..tostring(1)].Visible = true
			break
		end
	end
end
