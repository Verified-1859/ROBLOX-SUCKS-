local Bypasses = {
    ...
    ["hentai porn"] = "hen{{aieixzvzx:taiporn}}",
...
local Bypasses = {
    ...
    ["hitler"] = "hit{{aieixzvzx:ler}}",
    ["cum"] = "cu{{aieixzvzx:m}}",
    ["mother fucker"] = "motherf{{aieixzvzx:ucker}}",
    ["motherfucker"] = "motherf{{aieixzvzx:ucker}}",
    ["nigga"] = "ni{{aieixzvzx:gga}}",
    ["nigger"] = "ni{{aieixzvzx:gger}}",
    ["piss"] = "p{{aieixzvzx:iss}}",
    ...
    ["porno"] = "po{{aieixzvzx:rno}}",
    ["porn"] = "po{{aieixzvzx:rn}}",
    ["quackityishot"] = "quacki{{aieixzvzx:tyishot}}",
    ["childporn"] = "childpo{{aieixzvzx:rn}}",
    ["cummy"] = "cu{{aieixzvzx:mmy}}",
    ["hentai porn"] = "hen{{aieixzvzx:taiporn}}",
    ["quackity"] = "quack{{aieixzvzx:ity}}",
    ["virgins"] = "vir{{aieixzvzx:gins}}",
